...
from attacks.attack_methods.RLLC import RLLCAttack
...
class RLLCGeneration(Generation):
    def __init__(self, dataset, attack_name, targeted, raw_model_location, clean_data_location, adv_examples_dir,
        ...
        super(RLLCGeneration, self).__init__(dataset, attack_name, targeted, raw_model_location, clean_data_location,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--alpha_ratio', type=float, default=0.5,
                        help='the ratio of alpha value ralated to epsilon in RLLC')
