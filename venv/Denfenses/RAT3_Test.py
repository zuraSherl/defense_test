...
from Denfenses.DefenseMethods.RAT3 import RAT3Defense
...
def main(args):
    ...
    # 将参数传入RAT3防御中
    rat3 = RAT3Defense(model=model_framework, defense_name=defense_name, dataset=dataset, training_parameters=training_parameters, device=device,
                     **rat3_params)
    # 进行对抗训练
    rat3.defense(train_loader=train_loader, validation_loader=valid_loader)


if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='The RAT3 Defenses')
    # dataset：数据集名称MNIST/CIFAR10
