...
from Denfenses.DefenseMethods.RAT6 import RAT6Defense
...
def main(args):
    ...
    # 将参数传入RAT6防御中
    rat6 = RAT6Defense(model=model_framework, defense_name=defense_name, dataset=dataset, training_parameters=training_parameters, device=device,
                     **rat6_params)
    # 进行对抗训练
    rat6.defense(train_loader=train_loader, validation_loader=valid_loader)


if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='The RAT6 Defenses')
    # dataset：数据集名称MNIST/CIFAR10
