...
from Denfenses.DefenseMethods.RAT1 import RAT1Defense
...
def main(args):
    ...
    # 将参数传入RAT1防御中
    rat1 = RAT1Defense(model=model_framework, defense_name=defense_name, dataset=dataset, training_parameters=training_parameters, device=device,
                     **rat1_params)
    # 进行对抗训练
    rat1.defense(train_loader=train_loader, validation_loader=valid_loader)


if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='The RAT1 Defenses')
    # dataset：数据集名称MNIST/CIFAR10
