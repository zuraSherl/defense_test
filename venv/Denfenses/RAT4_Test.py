...
from Denfenses.DefenseMethods.RAT4 import RAT4Defense
...
def main(args):
    ...
    # 将参数传入RAT4防御中
    rat4 = RAT4Defense(model=model_framework, defense_name=defense_name, dataset=dataset, training_parameters=training_parameters, device=device,
                     **rat4_params)
    # 进行对抗训练
    rat4.defense(train_loader=train_loader, validation_loader=valid_loader)


if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='The RAT4 Defenses')
    # dataset：数据集名称MNIST/CIFAR10
