...
from Denfenses.DefenseMethods.RLT2 import RLT2Defense
...
def main(args):
    ...
    # 将参数传入RLT2防御中
    rlt2 = RLT2Defense(model=model_framework, defense_name=defense_name, dataset=dataset, training_parameters=training_parameters, device=device,
                     **rlt2_params)
    # 进行对抗训练
    rlt2.defense(train_loader=train_loader, validation_loader=valid_loader)

if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='The RLT2 Defenses')
    # dataset：数据集名称MNIST/CIFAR10
