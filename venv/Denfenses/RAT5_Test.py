...
from Denfenses.DefenseMethods.RAT5 import RAT5Defense
...
def main(args):
    ...
    # 将参数传入RAT5防御中
    rat5 = RAT5Defense(model=model_framework, defense_name=defense_name, dataset=dataset, training_parameters=training_parameters, device=device,
                     **rat5_params)
    # 进行对抗训练
    rat5.defense(train_loader=train_loader, validation_loader=valid_loader)


if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='The RAT5 Defenses')
    # dataset：数据集名称MNIST/CIFAR10
