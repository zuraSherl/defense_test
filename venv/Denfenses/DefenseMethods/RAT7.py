...
class RAT7Defense(Defense):
    def __init__(self, model=None, defense_name=None, dataset=None, training_parameters=None, device=None, **kwargs):
        ...
        super(RAT7Defense, self).__init__(model=model, defense_name=defense_name)
        self.model = model
    ...
    def _parsing_parameters(self, **kwargs):
        ...
        # rllc_alpha：rllc中llc的扰动大小
        self.epsilon = kwargs['epsilon']
        self.alpha = kwargs['alpha']
        self.adv_ration = kwargs['adv_ration']
        self.rllc_eps = kwargs['rllc_eps']
        self.rllc_alpha = kwargs['rllc_alpha']
        return True

    # 用RLLC方法产生对抗样本（每个llc对抗样本添加的扰动相同），返回对抗样本
    def random_llc_generation(self, var_natural_images=None):
        ...
        with torch.no_grad():
            ret_adv_images = clone_var_natural_images - self.rllc_alpha * gradients_sign
