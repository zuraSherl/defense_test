...
class RAT4Defense(Defense):
    def __init__(self, model=None, defense_name=None, dataset=None, training_parameters=None, device=None, **kwargs):
        ...
        super(RAT4Defense, self).__init__(model=model, defense_name=defense_name)
        self.model = model
    ...
    def random_llc_generation(self, var_natural_images=None):
        ...
        random_eps = np.random.normal(loc=self.eps_mu, scale=self.eps_sigma,
