...
class RLT2Defense(Defense):
    def __init__(self, model=None, defense_name=None, dataset=None, training_parameters=None, device=None, **kwargs):
        ...
        super(RLT2Defense, self).__init__(model=model, defense_name=defense_name)
        self.model = model
    ...
    def random_llc_generation(self, var_natural_images=None):
        ...
        ret_adv_images = torch.clamp(ret_adv_images,0.0,1.0)
