...
from Denfenses.DefenseMethods.RAT2 import RAT2Defense
...
def main(args):
    ...
    # 将参数传入RAT2防御中
    rat2 = RAT2Defense(model=model_framework, defense_name=defense_name, dataset=dataset, training_parameters=training_parameters, device=device,
                     **rat2_params)
    # 进行对抗训练
    rat2.defense(train_loader=train_loader, validation_loader=valid_loader)


if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='The RAT2 Defenses')
    # dataset：数据集名称MNIST/CIFAR10
