...
from Denfenses.DefenseMethods.RAT8 import RAT8Defense
...
def main(args):
    ...
    # 将参数传入RAT8防御中
    rat8 = RAT8Defense(model=model_framework, defense_name=defense_name, dataset=dataset, training_parameters=training_parameters, device=device,
                     **rat8_params)
    # 进行对抗训练
    rat8.defense(train_loader=train_loader, validation_loader=valid_loader)

if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='The RAT8 Defenses')
    # dataset：数据集名称MNIST/CIFAR10
